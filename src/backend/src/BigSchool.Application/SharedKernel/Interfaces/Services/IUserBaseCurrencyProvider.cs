...
///      disponibilidad/latencia de Finanzas/Investments a la de Auth (requiere retry/circuit
///      breaker/timeout/fallback).
///   B) Proyección local eventualmente consistente (recomendado) — Finanzas/Investments
...
///      leer esa proyección local en vez de llamar a Auth por red; Finanzas sigue funcionando
